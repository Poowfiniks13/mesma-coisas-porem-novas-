...
import Cardprodutos,{CardCarros,CardCompras,CardKpops,CardPosts,CardTarefas, CardNotas, CardViagens, CardDino} from './componentes/Cardprodutos'
...
<section>
  <div className="listacards">
    {
      carros.map((carro) => (
        <CardCarros c={carro} key={carro.id} />
      ))
    }
  </div>
</section>
...
<div className="listacards">
  {
    tarefas.map((tarefa) => (
      <CardTarefas t={tarefa} key={tarefa.id} />
    ))
  }
</div>
...
<section>
  ...
  <div className="listacards">
    {
      viagens.map((viagem) => (
        <CardViagens v={viagem} key={viagem.id} />
      ))
    }
  </div>
</section>
...
<div className="listacards">
  {
    compras.map((compra) => (
      <CardCompras c={compra} key={compra.id} />
    ))
  }
</div>
</section>
...
<div className="listacards">
  {
    kpops.map((kpops) => (
      <CardKpops c={kpops} key={kpops.id} />
    ))
  }
</div>
</section>
